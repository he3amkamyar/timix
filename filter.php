...
<div class="row">
    <form action="search.php" method="get">
        <input style="margin-right: 20px;" type="search" name="search">
        <input type="submit" value=" جستجو " name="sub">
    </form>
</div>
<br/>
<div class="row">
...
<?php
        ...
        $sql_filter = "SELECT * FROM product WHERE price BETWEEN '$n1' AND '$n2' ;";
        $query_filter = mysqli_query($conn,$sql_filter);
        while($res = mysqli_fetch_array($query_filter)):
?>
<div class="container">
    <div class="row">
